  ...
  Text(text = "BizCard")
    Surface( modifier = Modifier
        ...
        Card(modifier = Modifier
         ...
         backgroundColor = Color.White, elevation = 7.dp) {
...
fun Portfolio(data: List<String>) {
  LazyColumn{
       items(data) { item ->
           Card(modifier = Modifier
               .padding(13.dp)
               .fillMaxWidth(), shape = RectangleShape, elevation = 7.dp) {
...
private fun CreateInfo() {
    Column(
        modifier = Modifier.padding(5.dp), verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally
    ) {
        Text(
            text = "Anisha K.", style = MaterialTheme.typography.h4,
